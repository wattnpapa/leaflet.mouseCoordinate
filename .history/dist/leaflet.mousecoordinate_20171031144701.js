...
L.Control.mouseCoordinate  = L.Control.extend({
    ...
    _update: function(e){
        ...
        if(this.options.gps){
            ...
            content += "<tr><td>GPS</td><td>Lat: " + dLat + "</td><td>Lng: " + dLng +"</td></tr>";
        ...
        if(this.options.utm){
            ...
            if(utm !== undefined){
                content += "<tr><td>UTM</td><td colspan='2'>"+utm.zone+"&nbsp;x: " +utm.x+"&nbsp;" +utm.y+"</td></tr>";
            }
        }
        if(this.options.utmref){
            var utmref = UTMREF.fromUTM(UTM.fromLatLng(gps));
            if(utmref !== undefined){
                content += "<tr><td>UTM REF</td><td colspan='2'>"+utmref.zone+"&nbsp;" +utmref.band+"&nbsp; x: " +utmref.x+"&nbsp;" +utmref.y+"</td></tr>";
            }
        }
        if(this.options.qth){
